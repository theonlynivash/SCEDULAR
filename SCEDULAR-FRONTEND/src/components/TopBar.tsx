...
export default function TopBar({
  ...
  return (
    <header className="glass-chrome rounded-2xl px-3 py-2 flex items-center gap-2.5 flex-shrink-0 flex-wrap">
      ...
      <div className="flex items-center gap-1 glass-pill rounded-full p-1 h-9">
...
function ScopeSegment({ label, active, onClick }: { label: string; active: boolean; onClick: () => void }) {
  return (
    <button
      onClick={onClick}
      className={`h-7 px-3 inline-flex items-center rounded-full text-[13px] font-600 transition-all whitespace-nowrap ${
