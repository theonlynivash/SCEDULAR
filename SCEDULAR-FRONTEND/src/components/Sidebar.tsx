    ...
    >
      ...
      <nav className="flex-1 py-4 overflow-y-auto glass-scrollarea px-3 space-y-1">
        {navItems.map(item => (
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 text-[14px] rounded-2xl transition-all text-left ${page === item.page
      ...
      <div className="p-4 border-t border-white/10">
        <div className="flex items-center gap-3 px-2 py-1">
          <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-700 text-[#f3c326] bg-gradient-to-br from-[#0e254f] to-[#081a38] ring-1 ring-[#f3c326]/60">MS</div>
          <div className="flex-1 min-w-0">
            <p className="text-sm font-600 truncate text-white">Malathi.S</p>
            <p className="text-white/50 text-xs truncate">HOD · AI&amp;DS</p>
          </div>
        </div>
      </div>
    </aside>
