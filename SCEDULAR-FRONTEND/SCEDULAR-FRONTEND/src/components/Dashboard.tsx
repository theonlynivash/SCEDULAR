...
const statMeta = [
  { key: 'faculty', label: 'Total Faculty', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z', color: '#0F4C81', bg: '#e3f2fd' },
      ...
      <div className="grid gap-4" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
        {statMeta.map(s => (
          <div key={s.label} className="bg-white rounded-xl p-5 shadow-sm border border-slate-100 flex items-center gap-4">
            ...
            <div>
              <p className="text-2xl font-display font-800" style={{ color: s.color }}>{counts ? counts[s.key] : '—'}</p>
