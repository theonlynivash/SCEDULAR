...
export function solve(
  ...
  const ctx = buildContext(faculty, unavailability, config, labsByCourse, labsBySectionCourse)
  ...
  // that proof.
  return greedyFallback(ordered, faculty, unavailability, config, labsByCourse, labsBySectionCourse, budgetExceeded)
}
