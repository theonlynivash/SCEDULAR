import type { Conflict, Course, CourseRequirement, Faculty, Section, TeacherAssignment } from '../types.js'
import { contiguousGroups } from '../utils/grid.js'
import { getScheduleConfig } from '../db/repo.js'
...
export function preValidate(input: PreValidationInput): Conflict[] {
  ...
  const groups = contiguousGroups(getScheduleConfig().periods)
